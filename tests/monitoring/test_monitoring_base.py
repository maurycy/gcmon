...
class TestRunMonitoringLoop:
    ...
    def test_success(
        ...
        result = run_monitoring_loop(mock_process, mock_wait_policy, monitoring_options())
    ...
    def test_exception_returns_1(
        ...
        assert run_monitoring_loop(mock_process, mock_wait_policy, monitoring_options()) == 1
    ...
    def test_calls_cleanup(
        ...
        run_monitoring_loop(mock_process, mock_wait_policy, monitoring_options(), cleanup=cleanup)
    ...
    def test_does_not_call_cleanup_on_exception(
        ...
        result = run_monitoring_loop(mock_process, mock_wait_policy, monitoring_options(), cleanup=cleanup)
    ...
    def test_stdout_format_no_trace_path(
        ...
        run_monitoring_loop(mock_process, mock_wait_policy, monitoring_options(output_format="stdout"))
