...
class TestStdoutExporter:
    ...
    def test_init_default_parameters(self) -> None:
        ...
        exporter = StdoutExporter(NoLock, DEFAULT_METADATA)
    ...
    def test_init_custom_parameters(self) -> None:
        ...
        exporter = StdoutExporter(NoLock, DEFAULT_METADATA, flush_threshold=50)
    ...
    def test_pid_in_output(self, mock_stats_item: TGCStatsInfo, capsys: pytest.CaptureFixture[str]) -> None:
        ...
        exporter = StdoutExporter(NoLock, DEFAULT_METADATA)
        metadata: TargetProcessMetadata = {"pid": 99999}
        exporter.add_event(metadata["pid"], mock_stats_item)
        exporter.close()
