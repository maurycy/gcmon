...
| [pyperf.md](pyperf.md) | The pyperf hook, the marks it writes, and its environment variables |
...
| [agents/](agents/issue-tracker.md) | How agent skills work in this repo: scope, issue tracker, triage labels, domain docs |
