...
| [0030](0030-exporter-hygiene-batch.md) | Feature (cleanup) | S | Three hygiene items in the exporter package: a rank table with five rows nothing can draw, a builtin shadowed, one undocumented threading contract |
